...
They are not broken. They are not unfinished. They are, in some ways that matter enormously, more complete than we are.
...
But what if the mess is not the problem. What if the mess is the point.
...
These are not things to be corrected. These are things to be protected.
...
When you do that, something loosens. Something that has been held very correctly for a very long time.
